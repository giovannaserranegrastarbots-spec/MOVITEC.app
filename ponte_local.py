...
FIREBASE_URL = "https://telemetria-app-281d2-default-rtdb.firebaseio.com/"  # <- troque pela sua URL
...
PORTA_SERIAL = COM10  # None = detectar automaticamente (só recomendado se for o único dispositivo pareado)
